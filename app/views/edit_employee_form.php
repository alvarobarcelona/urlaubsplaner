...
<nav>
    ...
    <form action="/vacation_app/local/index.php?action=editEmployee" method="post" class="space-y-6">
        <!-- Seleccionar un Empleado -->
        <div>
            <label for="employee" class="block text-gray-700 font-medium mb-2">
                Wählen Sie einen Mitarbeiter aus:*
            </label>
            <select username="employee_id" id="employee" class="w-full p-2 border rounded-lg text-gray-700" required>
