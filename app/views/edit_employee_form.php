    ...
    <ul class="nav-menu">
        ...
        <li class="dropdown">
            ...
            <ul class="dropdown-menu">
                ...
                <li><a href="/vacation_app/local/index.php?action=createVacationRequestAdmin">Abwesenheit eintragen
                    </a></li>
    ...
    <div class="container max-w-4xl mx-auto mt-8 p-6 bg-white rounded-lg shadow-lg">
        ...
        <form action="/vacation_app/local/index.php?action=editEmployee" method="post">
            ...
            <div>
                ...
                <input type="text" name="username" id="username" class="w-full p-2 border rounded-lg text-gray-700"
                       value="">
            </div>
            ...
            <div>
                ...
                <input type="number" name="total_vacation_days" id="vacation_days" min="0.5" step="0.5"
            ...
            <div>
                ...
                <input type="password" name="password" id="password" class="w-full p-2 border rounded-lg text-gray-700"
                       value="">
            </div>
