        ...
        <ul>
            ...
            <div style="margin-left: auto;">
                ...
                <span> <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" class="icon-user">
                    ...
                    </svg> Wilkommen,<?php echo htmlspecialchars($user_name); ?></span>
            </div>
                    ...
                    <tr>
                        ...
                        <td style="text-align: center;">
                            <form action="/vacation_app/local/index.php?action=approveRejectRequest" method="post">
                                ...
                                <button style="margin: 10px auto;" type="submit" name="action" value="approve">Genehmigen </button>
                                <button style="margin-left: 10px;" type="submit" name="action" value="reject">Ablehnen</button>
                            </form>
                        </td>
                    </tr>
                <?php  }
