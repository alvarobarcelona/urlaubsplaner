...
<body>
    <nav>
        ...
        <li><a href="/vacation_app/app/views/general_dashboard.php">Kalender Anzeigen</a></li>
    ...
    <h2>Anträge, die zur Überprüfung stehen</h2>
    ...
    if (!empty($requests)) {
        ...
        <tr>
            <td colspan="4">No hay solicitudes pendientes de revisar</td>
        </tr>
    <?php } ?>
</tbody>
