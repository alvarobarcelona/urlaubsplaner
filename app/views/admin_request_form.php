    ...
    <ul class="nav-menu">
        ...
        <li class="dropdown">
            ...
            <ul class="dropdown-menu">
                ...
                <li><a href="/vacation_app/local/index.php?action=createVacationRequestAdmin">Abwesenheit eintragen (Als
                        Admin)</a></li>
...
<div class="h-screen flex items-center justify-center">
    <div class="bg-gray-100 container flex items-center justify-center mx-auto align-middle  ">
        ...
        <div class="bg-white shadow-lg rounded-lg p-8 max-w-lg w-full  ">
            ...
            <form action="/vacation_app/local/index.php?action=createVacationRequestAdmin" method="post"
                  class="space-y-4">
                <div>
                    <label for="employee_id" class="block text-sm font-medium text-gray-700 mb-1">Mitarbeiter
                        auswählen:</label>
                    <select id="employee_id" name="employee_id"
                            class="p-1 block w-full border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 text-sm"
                            required>
                ...
                <div>
                    <label for="vacation_type_id" class="block text-sm font-medium text-gray-700 mb-1">Art des
                        Antrags:</label>
                    <select id="vacation_type_id" name="vacation_type_id"
                            class="p-1 block w-full border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 text-sm"
                            required>
                ...
                <div>
                    <label for="start_time" class="block text-sm font-medium text-gray-700 mb-1">Startzeit
                        (Optional):</label>
                ...
                <div>
                    <label for="end_time" class="block text-sm font-medium text-gray-700 mb-1">Endzeit
                        (Optional):</label>
                ...
                <div class="flex justify-between mt-6">
                    ...
                    <button type="button"
                            class="px-4 py-2 bg-gray-300 text-gray-700 rounded-md shadow hover:bg-gray-400 focus:outline-none focus:ring-2 focus:ring-gray-300 focus:ring-offset-2"
                            onclick="window.location.href='/vacation_app/app/views/admin_dashboard.php';">Abbrechen
                    </button>
                </div>
            </form>
        </div>
