...
<body class="flex flex-col min-h-screen">
    ...
    <div class="max-w-lg mx-auto  bg-white shadow-md rounded-lg p-6" style="margin-top: 30px;">
    <h2 class="text-2xl font-semibold text-gray-800 text-center mb-4">Benutzerprofil</h2>
    <p class="text-gray-600 text-center mb-6">Mit diesem Formular können Sie im Falle eines Fehlers einige Ihrer Daten aktualisieren. In anderen Fällen wenden Sie sich bitte an den Administrator.</p>

    <!-- Formulario para editar el perfil -->
    <form action="/vacation_app/local/index.php?action=updateProfile" method="post" class="space-y-4">
        <!-- Benutzername -->
        <div>
